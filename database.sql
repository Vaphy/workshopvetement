...
create table vetement (id int AUTO_INCREMENT, dressing_id int NOT NULL, path_photo varchar(255), color varchar(255), type int, url_photo varchar(255), PRIMARY KEY (id), FOREIGN KEY (dressing_id) REFERENCES dressing(id));
...
insert into vetement (dressing_id, color, type) values ('1', '#0000FF', '0');
insert into vetement (dressing_id, color, type) values ('2', '#FF0000', '1');
insert into vetement (dressing_id, color, type) values ('2', '#FFFF00', '2');
